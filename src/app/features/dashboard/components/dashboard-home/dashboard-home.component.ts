      ...
      <div class="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-3xl p-8 text-white shadow-lg mb-8">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-primary-100 text-lg">Esto es lo que está sucediendo con tus proyectos hoy</p>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-soft p-6 border border-neutral-100">
          ...
          <div class="space-y-3">
            ...
            <a routerLink="/equipo"
              ...
              <span class="font-medium">Ver Equipo</span>
              <svg class="w-4 h-4 ml-auto group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
              </svg>
            </a>
